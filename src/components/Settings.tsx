...
import { formatHeading } from '../utils/headingFormatter';
import type { CustomHeadingFormat } from '../utils/headingFormatter';
...
const Settings: React.FC<SettingsProps> = ({ 
  ...
  const generateCustomPreview = (format: CustomHeadingFormat): string => {
    return formatHeading('Heading', 'custom', format);
  };
          ...
          <div className="settings-section">
            ...
            <div className="custom-format-controls">
              ...
              <label className="custom-format-option">
                <input
                  type="checkbox"
                  checked={Boolean(customHeadingFormat.useBold)}
                  onChange={(e) => onCustomHeadingFormatChange({
                    ...customHeadingFormat,
