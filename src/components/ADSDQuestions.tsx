...
const ADSDQuestions: React.FC<ADSDQuestionsProps> = ({ formData, onFormDataChange }) => {
  ...
  const handleInputChange = (field: keyof ADSDFormData, value: any) => {
    onFormDataChange({ [field]: value });
  };

  const handleIncomeChange = (field: keyof ADSDFormData['income'], value: number) => {
    onFormDataChange({
      income: {
        ...formData.income,
        [field]: value,
  ...
  return (
    <div className="form-sections-container">
      ...
      <ADSDPaymentSection
        ...
        onBankAccountChange={(account) => handleInputChange('bankAccount', account)}
